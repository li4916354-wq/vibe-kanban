...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        server::routes::open_remote_editor::OpenRemoteEditorWithStoredCredentialsRequest::decl(),
        server::routes::open_remote_editor::UpsertOpenRemoteEditorCredentialsRequest::decl(),
        server::routes::open_remote_editor::UpsertOpenRemoteEditorCredentialsResponse::decl(),
